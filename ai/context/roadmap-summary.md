...
| 2 | Event Streaming | Rule engine, incident management, event replay, **real-time updates via SSE invalidate (not WebSocket — data flow is purely server→client; decided 2026-07-13)**, **alert acknowledgment/resolution workflow, alert escalation rules** |
