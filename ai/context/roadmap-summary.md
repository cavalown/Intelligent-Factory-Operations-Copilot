...
| 3 | Operational Intelligence | SOP knowledge base, RAG, event search, root cause analysis, **concrete production analytics (downtime frequency, MTTA/MTTR, repeated-issue patterns, bottleneck identification)** |
